...
class BookControllerTest {
    ...
    void shouldReturnBooks() {
        ...
        ResponseEntity<ApiResponseDto<Page<BookEntity>>> response = bookController.getBooks(pageable);
    ...
    void shouldReturnAllBooks() {
        ...
        ResponseEntity<ApiResponseDto<List<BookEntity>>> response = bookController.getAllBooks();
