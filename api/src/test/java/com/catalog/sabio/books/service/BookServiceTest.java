...
class BookServiceTest {
    ...
    void shouldReturnAllBooks() {
        ...
        var result = bookService.getBooksAll();
    ...
    @Test
    void shouldThrowExceptionWhenNoBooksFoundInAll() {
        when(bookRepository.findAll()).thenReturn(List.of());

        var ex = assertThrows(BookNotFoundException.class, () -> bookService.getBooksAll());
        assertEquals("Nenhum livro encontrado", ex.getMessage());
    }
